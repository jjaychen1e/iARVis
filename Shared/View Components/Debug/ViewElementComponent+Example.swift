...
extension ViewElementComponent {
    ...
    static let exampleChartConfigurationDecodeJSONStr = """
    {
        "vStack": {
            "elements": [
                {
                    "chart": \(ChartConfigurationExample.exampleJSONString1)
                },
                {
                    "text": {
    ...
    static let exampleLineChartConfigurationDecodeJSONStr = """
    {
        "vStack": {
            "elements": [
                {
                    "chart": \(ChartConfigurationExample.exampleJSONString2)
                },
                {
                    "text": {
    ...
    {"chart":\(ChartConfigurationExample.exampleJSONString3)}
    """.data(using: .utf8)!)
